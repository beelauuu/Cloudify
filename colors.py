...
chinese_new_year_colors = ["#CC232A","#F5AC27","#FFD84B","#F2888B","#A3262A","#CC9902"]
...
def fall_color_func(word, font_size, position, orientation, random_state=None, **kwargs):
    return random.choice(tree_colors)

def summer_color_func(word, font_size, position, orientation, random_state=None, **kwargs):
...
def chinese_new_year_color_func(word, font_size, position, orientation, random_state=None, **kwargs):
    return random.choice(chinese_new_year_colors)

def spotify_green_color_func(word, font_size, position, orientation, random_state=None, **kwargs):
    return "#1DB954"